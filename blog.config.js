...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'photo', // 锁定默认主题为hexo, // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '🍒Cherryischerry', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱笑的星星人✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cherryischerry.xyz', // 网站地址
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'siqixu147@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/augustdiane147/', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1860792521?spm_id_from=333.337.0.0', // B站主页
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个牛马人, Hi，我是一个星星人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
